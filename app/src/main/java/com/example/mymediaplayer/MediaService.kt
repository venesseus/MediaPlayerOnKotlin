...
class MediaService : Service(), MediaPlayerCallback {
    ...
    private fun init() {
        ...
        val afd = applicationContext.resources.openRawResourceFd(R.raw.asmalibrasi_soegi_bornean)
        try {
    ...
    private fun showNotif() {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_DEFAULT_IMPORTANCE)
            .setContentTitle("MUSIK NYALA NIH BOS")
            .setContentText("Soegi Bornean the best")
